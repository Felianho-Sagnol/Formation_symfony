...
class User implements UserInterface
{
     ...
     *@Assert\Length(min=2,minMessage="il faut au moins 8 caractères")
     */
    private $firstName;
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Length(min=8,minMessage="il faut au moins 8 caractères")
     */
    private $hash;
     ...
     * @Assert\Length(min=10,minMessage="il faut au moins 8 caractères")
     */
    private $description;
